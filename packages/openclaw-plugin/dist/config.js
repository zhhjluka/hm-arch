...
export function resolvePluginConfig(pluginConfig, resolvePath) {
    ...
    return {
        ...
        maxContextChars: readPositiveInt(raw.maxContextChars, DEFAULT_PLUGIN_CONFIG.maxContextChars),
        consolidateOnSessionEnd: readBoolean(raw.consolidateOnSessionEnd, DEFAULT_PLUGIN_CONFIG.consolidateOnSessionEnd),
        requestTimeoutMs: readPositiveInt(raw.requestTimeoutMs, DEFAULT_PLUGIN_CONFIG.requestTimeoutMs),
        startupTimeoutMs: readPositiveInt(raw.startupTimeoutMs, DEFAULT_PLUGIN_CONFIG.startupTimeoutMs),
        maxRestartBackoffMs: readPositiveInt(raw.maxRestartBackoffMs, DEFAULT_PLUGIN_CONFIG.maxRestartBackoffMs),
    };
}
