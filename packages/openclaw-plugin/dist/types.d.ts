...
export declare const DEFAULT_MAX_CONTEXT_CHARS = 4000;
export declare const DEFAULT_REQUEST_TIMEOUT_MS = 30000;
export declare const DEFAULT_DB_FILENAME = "hm_arch_memory.db";
export type OpenClawPluginApi = {
    ...
    registerHook: (events: string | string[], handler: HookHandler, opts?: {
        catchErrors?: boolean;
    }) => void;
