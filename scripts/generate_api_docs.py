...
def build_markdown() -> str:
    ...
    lines += [
        ...
        "| `chroma` | `chromadb>=0.5.0` (source: `pip install -e '.[chroma]'`; v1.0.0 "
        "GitHub wheel: `pip install 'hm_arch-*.whl[chroma]'`; v1.1.0+ after PyPI approval: "
        "`pip install 'hm-arch[chroma]'` — see [RELEASE_CHECKLIST.md](RELEASE_CHECKLIST.md)) | "
        "`chroma_persist_directory` or "
